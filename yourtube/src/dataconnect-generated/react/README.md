...
## GetVideo
You can execute the `GetVideo` Query using the following Query hook function, which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts):

```javascript
useGetVideo(dc: DataConnect, options?: useDataConnectQueryOptions<GetVideoData>): UseDataConnectQueryResult<GetVideoData, undefined>;
```
You can also pass in a `DataConnect` instance to the Query hook function.
```javascript
useGetVideo(options?: useDataConnectQueryOptions<GetVideoData>): UseDataConnectQueryResult<GetVideoData, undefined>;
```

### Variables
The `GetVideo` Query has no variables.
### Return Type
Recall that calling the `GetVideo` Query hook function returns a `UseQueryResult` object. This object holds the state of your Query, including whether the Query is loading, has completed, or has succeeded/failed, and any data returned by the Query, among other things.

To check the status of a Query, use the `UseQueryResult.status` field. You can also check for pending / success / error status using the `UseQueryResult.isPending`, `UseQueryResult.isSuccess`, and `UseQueryResult.isError` fields.

To access the data returned by a Query, use the `UseQueryResult.data` field. The data for the `GetVideo` Query is of type `GetVideoData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `GetVideo`'s Query hook function

```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig } from '@dataconnect/generated';
import { useGetVideo } from '@dataconnect/generated/react'

export default function GetVideoComponent() {
  // You don't have to do anything to "execute" the Query.
  // Call the Query hook function to get a `UseQueryResult` object which holds the state of your Query.
  const query = useGetVideo();

  // You can also pass in a `DataConnect` instance to the Query hook function.
  const dataConnect = getDataConnect(connectorConfig);
  const query = useGetVideo(dataConnect);

  // You can also pass in a `useDataConnectQueryOptions` object to the Query hook function.
  const options = { staleTime: 5 * 1000 };
  const query = useGetVideo(options);

  // You can also pass both a `DataConnect` instance and a `useDataConnectQueryOptions` object.
  const dataConnect = getDataConnect(connectorConfig);
  const options = { staleTime: 5 * 1000 };
  const query = useGetVideo(dataConnect, options);
...
## ListVideos
You can execute the `ListVideos` Query using the following Query hook function, which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts):

```javascript
useListVideos(dc: DataConnect, options?: useDataConnectQueryOptions<ListVideosData>): UseDataConnectQueryResult<ListVideosData, undefined>;
```
You can also pass in a `DataConnect` instance to the Query hook function.
```javascript
useListVideos(options?: useDataConnectQueryOptions<ListVideosData>): UseDataConnectQueryResult<ListVideosData, undefined>;
```

### Variables
The `ListVideos` Query has no variables.
### Return Type
Recall that calling the `ListVideos` Query hook function returns a `UseQueryResult` object. This object holds the state of your Query, including whether the Query is loading, has completed, or has succeeded/failed, and any data returned by the Query, among other things.

To check the status of a Query, use the `UseQueryResult.status` field. You can also check for pending / success / error status using the `UseQueryResult.isPending`, `UseQueryResult.isSuccess`, and `UseQueryResult.isError` fields.

To access the data returned by a Query, use the `UseQueryResult.data` field. The data for the `ListVideos` Query is of type `ListVideosData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `ListVideos`'s Query hook function

```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig } from '@dataconnect/generated';
import { useListVideos } from '@dataconnect/generated/react'

export default function ListVideosComponent() {
  // You don't have to do anything to "execute" the Query.
  // Call the Query hook function to get a `UseQueryResult` object which holds the state of your Query.
  const query = useListVideos();

  // You can also pass in a `DataConnect` instance to the Query hook function.
  const dataConnect = getDataConnect(connectorConfig);
  const query = useListVideos(dataConnect);

  // You can also pass in a `useDataConnectQueryOptions` object to the Query hook function.
  const options = { staleTime: 5 * 1000 };
  const query = useListVideos(options);

  // You can also pass both a `DataConnect` instance and a `useDataConnectQueryOptions` object.
  const dataConnect = getDataConnect(connectorConfig);
  const options = { staleTime: 5 * 1000 };
  const query = useListVideos(dataConnect, options);
...
## GetLikes
You can execute the `GetLikes` Query using the following Query hook function, which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts):

```javascript
useGetLikes(dc: DataConnect, options?: useDataConnectQueryOptions<GetLikesData>): UseDataConnectQueryResult<GetLikesData, undefined>;
```
You can also pass in a `DataConnect` instance to the Query hook function.
```javascript
useGetLikes(options?: useDataConnectQueryOptions<GetLikesData>): UseDataConnectQueryResult<GetLikesData, undefined>;
```

### Variables
The `GetLikes` Query has no variables.
### Return Type
Recall that calling the `GetLikes` Query hook function returns a `UseQueryResult` object. This object holds the state of your Query, including whether the Query is loading, has completed, or has succeeded/failed, and any data returned by the Query, among other things.

To check the status of a Query, use the `UseQueryResult.status` field. You can also check for pending / success / error status using the `UseQueryResult.isPending`, `UseQueryResult.isSuccess`, and `UseQueryResult.isError` fields.

To access the data returned by a Query, use the `UseQueryResult.data` field. The data for the `GetLikes` Query is of type `GetLikesData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `GetLikes`'s Query hook function

```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig } from '@dataconnect/generated';
import { useGetLikes } from '@dataconnect/generated/react'

export default function GetLikesComponent() {
  // You don't have to do anything to "execute" the Query.
  // Call the Query hook function to get a `UseQueryResult` object which holds the state of your Query.
  const query = useGetLikes();

  // You can also pass in a `DataConnect` instance to the Query hook function.
  const dataConnect = getDataConnect(connectorConfig);
  const query = useGetLikes(dataConnect);

  // You can also pass in a `useDataConnectQueryOptions` object to the Query hook function.
  const options = { staleTime: 5 * 1000 };
  const query = useGetLikes(options);

  // You can also pass both a `DataConnect` instance and a `useDataConnectQueryOptions` object.
  const dataConnect = getDataConnect(connectorConfig);
  const options = { staleTime: 5 * 1000 };
  const query = useGetLikes(dataConnect, options);
...
```javascript
useCreateVideo(options?: useDataConnectMutationOptions<CreateVideoData, FirebaseError, void>): UseDataConnectMutationResult<CreateVideoData, undefined>;
```
You can also pass in a `DataConnect` instance to the Mutation hook function.
```javascript
useCreateVideo(dc: DataConnect, options?: useDataConnectMutationOptions<CreateVideoData, FirebaseError, void>): UseDataConnectMutationResult<CreateVideoData, undefined>;
```
...
```javascript
useUpdateVideo(options?: useDataConnectMutationOptions<UpdateVideoData, FirebaseError, void>): UseDataConnectMutationResult<UpdateVideoData, undefined>;
```
You can also pass in a `DataConnect` instance to the Mutation hook function.
```javascript
useUpdateVideo(dc: DataConnect, options?: useDataConnectMutationOptions<UpdateVideoData, FirebaseError, void>): UseDataConnectMutationResult<UpdateVideoData, undefined>;
```
...
## DeleteVideo
You can execute the `DeleteVideo` Mutation using the `UseMutationResult` object returned by the following Mutation hook function (which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts)):
```javascript
useDeleteVideo(options?: useDataConnectMutationOptions<DeleteVideoData, FirebaseError, void>): UseDataConnectMutationResult<DeleteVideoData, undefined>;
```
You can also pass in a `DataConnect` instance to the Mutation hook function.
```javascript
useDeleteVideo(dc: DataConnect, options?: useDataConnectMutationOptions<DeleteVideoData, FirebaseError, void>): UseDataConnectMutationResult<DeleteVideoData, undefined>;
```

### Variables
The `DeleteVideo` Mutation has no variables.
### Return Type
Recall that calling the `DeleteVideo` Mutation hook function returns a `UseMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.

To check the status of a Mutation, use the `UseMutationResult.status` field. You can also check for pending / success / error status using the `UseMutationResult.isPending`, `UseMutationResult.isSuccess`, and `UseMutationResult.isError` fields.

To execute the Mutation, call `UseMutationResult.mutate()`. This function executes the Mutation, but does not return the data from the Mutation.

To access the data returned by a Mutation, use the `UseMutationResult.data` field. The data for the `DeleteVideo` Mutation is of type `DeleteVideoData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `DeleteVideo`'s Mutation hook function

```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig } from '@dataconnect/generated';
import { useDeleteVideo } from '@dataconnect/generated/react'

export default function DeleteVideoComponent() {
  // Call the Mutation hook function to get a `UseMutationResult` object which holds the state of your Mutation.
  const mutation = useDeleteVideo();

  // You can also pass in a `DataConnect` instance to the Mutation hook function.
  const dataConnect = getDataConnect(connectorConfig);
  const mutation = useDeleteVideo(dataConnect);

  // You can also pass in a `useDataConnectMutationOptions` object to the Mutation hook function.
  const options = {
    onSuccess: () => { console.log('Mutation succeeded!'); }
  };
  const mutation = useDeleteVideo(options);
  ...
  const mutation = useDeleteVideo(dataConnect, options);
  ...
  // If the Mutation is successful, you can access the data returned using the `UseMutationResult.data` field.
  if (mutation.isSuccess) {
    console.log(mutation.data.video_delete);
  }
  return <div>Mutation execution {mutation.isSuccess ? 'successful' : 'failed'}!</div>;
}
```
...
## LikeVideo
You can execute the `LikeVideo` Mutation using the `UseMutationResult` object returned by the following Mutation hook function (which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts)):
```javascript
useLikeVideo(options?: useDataConnectMutationOptions<LikeVideoData, FirebaseError, void>): UseDataConnectMutationResult<LikeVideoData, undefined>;
```
You can also pass in a `DataConnect` instance to the Mutation hook function.
```javascript
useLikeVideo(dc: DataConnect, options?: useDataConnectMutationOptions<LikeVideoData, FirebaseError, void>): UseDataConnectMutationResult<LikeVideoData, undefined>;
```

### Variables
The `LikeVideo` Mutation has no variables.
### Return Type
Recall that calling the `LikeVideo` Mutation hook function returns a `UseMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.

To check the status of a Mutation, use the `UseMutationResult.status` field. You can also check for pending / success / error status using the `UseMutationResult.isPending`, `UseMutationResult.isSuccess`, and `UseMutationResult.isError` fields.

To execute the Mutation, call `UseMutationResult.mutate()`. This function executes the Mutation, but does not return the data from the Mutation.

To access the data returned by a Mutation, use the `UseMutationResult.data` field. The data for the `LikeVideo` Mutation is of type `LikeVideoData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `LikeVideo`'s Mutation hook function

```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig } from '@dataconnect/generated';
import { useLikeVideo } from '@dataconnect/generated/react'

export default function LikeVideoComponent() {
  // Call the Mutation hook function to get a `UseMutationResult` object which holds the state of your Mutation.
  const mutation = useLikeVideo();

  // You can also pass in a `DataConnect` instance to the Mutation hook function.
  const dataConnect = getDataConnect(connectorConfig);
  const mutation = useLikeVideo(dataConnect);

  // You can also pass in a `useDataConnectMutationOptions` object to the Mutation hook function.
  const options = {
    onSuccess: () => { console.log('Mutation succeeded!'); }
  };
  const mutation = useLikeVideo(options);
  ...
  const mutation = useLikeVideo(dataConnect, options);
...
## UnlikeVideo
You can execute the `UnlikeVideo` Mutation using the `UseMutationResult` object returned by the following Mutation hook function (which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts)):
```javascript
useUnlikeVideo(options?: useDataConnectMutationOptions<UnlikeVideoData, FirebaseError, void>): UseDataConnectMutationResult<UnlikeVideoData, undefined>;
```
You can also pass in a `DataConnect` instance to the Mutation hook function.
```javascript
useUnlikeVideo(dc: DataConnect, options?: useDataConnectMutationOptions<UnlikeVideoData, FirebaseError, void>): UseDataConnectMutationResult<UnlikeVideoData, undefined>;
```

### Variables
The `UnlikeVideo` Mutation has no variables.
### Return Type
Recall that calling the `UnlikeVideo` Mutation hook function returns a `UseMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.

To check the status of a Mutation, use the `UseMutationResult.status` field. You can also check for pending / success / error status using the `UseMutationResult.isPending`, `UseMutationResult.isSuccess`, and `UseMutationResult.isError` fields.

To execute the Mutation, call `UseMutationResult.mutate()`. This function executes the Mutation, but does not return the data from the Mutation.

To access the data returned by a Mutation, use the `UseMutationResult.data` field. The data for the `UnlikeVideo` Mutation is of type `UnlikeVideoData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `UnlikeVideo`'s Mutation hook function

```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig } from '@dataconnect/generated';
import { useUnlikeVideo } from '@dataconnect/generated/react'

export default function UnlikeVideoComponent() {
  // Call the Mutation hook function to get a `UseMutationResult` object which holds the state of your Mutation.
  const mutation = useUnlikeVideo();

  // You can also pass in a `DataConnect` instance to the Mutation hook function.
  const dataConnect = getDataConnect(connectorConfig);
  const mutation = useUnlikeVideo(dataConnect);

  // You can also pass in a `useDataConnectMutationOptions` object to the Mutation hook function.
  const options = {
    onSuccess: () => { console.log('Mutation succeeded!'); }
  };
  const mutation = useUnlikeVideo(options);
  ...
  const mutation = useUnlikeVideo(dataConnect, options);
...
```javascript
useSubscribe(options?: useDataConnectMutationOptions<SubscribeData, FirebaseError, void>): UseDataConnectMutationResult<SubscribeData, undefined>;
```
You can also pass in a `DataConnect` instance to the Mutation hook function.
```javascript
useSubscribe(dc: DataConnect, options?: useDataConnectMutationOptions<SubscribeData, FirebaseError, void>): UseDataConnectMutationResult<SubscribeData, undefined>;
```
...
## Unsubscribe
You can execute the `Unsubscribe` Mutation using the `UseMutationResult` object returned by the following Mutation hook function (which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts)):
```javascript
useUnsubscribe(options?: useDataConnectMutationOptions<UnsubscribeData, FirebaseError, void>): UseDataConnectMutationResult<UnsubscribeData, undefined>;
```
You can also pass in a `DataConnect` instance to the Mutation hook function.
```javascript
useUnsubscribe(dc: DataConnect, options?: useDataConnectMutationOptions<UnsubscribeData, FirebaseError, void>): UseDataConnectMutationResult<UnsubscribeData, undefined>;
```

### Variables
The `Unsubscribe` Mutation has no variables.
### Return Type
Recall that calling the `Unsubscribe` Mutation hook function returns a `UseMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.

To check the status of a Mutation, use the `UseMutationResult.status` field. You can also check for pending / success / error status using the `UseMutationResult.isPending`, `UseMutationResult.isSuccess`, and `UseMutationResult.isError` fields.

To execute the Mutation, call `UseMutationResult.mutate()`. This function executes the Mutation, but does not return the data from the Mutation.

To access the data returned by a Mutation, use the `UseMutationResult.data` field. The data for the `Unsubscribe` Mutation is of type `UnsubscribeData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `Unsubscribe`'s Mutation hook function

```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig } from '@dataconnect/generated';
import { useUnsubscribe } from '@dataconnect/generated/react'
...
export default function UnsubscribeComponent() {
  ...
  // You can also pass in a `DataConnect` instance to the Mutation hook function.
  const dataConnect = getDataConnect(connectorConfig);
  const mutation = useUnsubscribe(dataConnect);

  // You can also pass in a `useDataConnectMutationOptions` object to the Mutation hook function.
  const options = {
    onSuccess: () => { console.log('Mutation succeeded!'); }
  };
  const mutation = useUnsubscribe(options);
  ...
  const mutation = useUnsubscribe(dataConnect, options);
